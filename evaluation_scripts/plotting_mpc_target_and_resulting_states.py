...
def plot_single_trajectories(res):
    # Low Disc
    x_planned = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//control_and_ai//evaluation_scripts//'
                            'mpc//x_planned.npy')
    y_planned = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//control_and_ai//evaluation_scripts//'
                        'mpc//y_planned.npy')

    x_target = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//control_and_ai//evaluation_scripts//'
                        'mpc//x_target.npy')
    y_target = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//control_and_ai//evaluation_scripts//'
                       'mpc//y_target.npy')

    resulting_states = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//control_and_ai//evaluation_scripts//'
