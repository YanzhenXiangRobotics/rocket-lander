...
def plot_pid_and_ddpg_trajectories(res):
    # Low Disc
    # state_history = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//rl_and_control//evaluation_scripts//'
    #                         'rl_q_learning//low_discretization//final_state_history.npy')
    # -------------------------------
    state_history = np.load('C://Users//xyz00//OneDrive//Desktop//rocket-lander//control_and_ai//control_and_ai//evaluation_scripts//'
